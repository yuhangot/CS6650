...
public class MultiThreadedSkierClient {
  ...
  private static final int REMAIN_NUMBER_OF_THREADS = 196;
  private static final String BASE_URL = "http://ServletLB-1060559371.us-west-2.elb.amazonaws.com/Upic-1.0-SNAPSHOT/";

  private static final String ENDPOINT = "liftRides";
